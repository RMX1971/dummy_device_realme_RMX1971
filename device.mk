...
PRODUCT_COPY_FILES += \
    ...
    frameworks/native/data/etc/system/system/android.hardware.audio.pro.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/system/system/android.hardware.audio.pro.xml \
    ...
    frameworks/native/data/etc/system/system/android.hardware.sensor.ambient_temperature.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/system/system/android.hardware.sensor.ambient_temperature.xml \
    ...
    frameworks/native/data/etc/system/system/android.hardware.sensor.relative_humidity.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/system/system/android.hardware.sensor.relative_humidity.xml \
    ...
    frameworks/native/data/etc/system/system/android.hardware.vulkan.level-1.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/system/system/android.hardware.vulkan.level-1.xml \
    ...
    frameworks/native/data/etc/system/system/android.software.ipsec_tunnels.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/system/system/android.software.ipsec_tunnels.xml \
